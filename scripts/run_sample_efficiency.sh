#!/bin/bash
# Sample-efficiency curves: 4 VABL configs at 4 training budgets.
# Reveals whether the pathology grows with training budget or is constant.
#
# Matrix: 4 configs × 4 budgets × 5 seeds = 80 runs
# Budgets: 1250ep (200K steps), 6250ep (1M), 12500ep (5M), 25000ep (10M)
#
# The 10M budget overlaps with Phase 2 minimal — those JSONs already exist.
# We skip any run whose JSON exists, so this script only generates the
# shorter-budget runs (~60 new runs).
#
# Results in results/sample_efficiency/.
...
HORIZON=400
SEEDS="0 1 2 3 4"
OUT_DIR=results/sample_efficiency
...
run_one() {
    ...
    local save="$OUT_DIR/se_${name}_${budget_tag}_seed${seed}.json"
...
log "============================================="
log "Sample-efficiency curves STARTED"
...
log "============================================="
log "Sample-efficiency curves COMPLETE"
