...
generalizes across attention-based actor variants, mean pooling is
immune, and critic-side placement reverses the sign. We additionally
...
VABL (AA). The instability persists even as the auxiliary gradient
magnitude decreases across training, confirming a directional rather
