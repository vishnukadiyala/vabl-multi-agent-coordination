...
multi-agent reinforcement learning (MARL). We identify a directional
gradient-interference pathology in this pattern under co-learning
non-stationarity. In 10M-step reruns of the published AERIAL
architecture~\cite{phan2023attention} on Overcooked, most seeds
exhibit a characteristic late-training drop after reaching peak
reward; one seed fails to converge. To isolate the mechanism we
construct VABL as a minimal architecture in the same class and run a
7-configuration ablation across Overcooked, SMAX, and MPE. On the
