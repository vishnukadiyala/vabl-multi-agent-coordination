...
\textbf{Narrow load-bearing claims:} The $\lambda$-threshold is based
on two values ($\lambda{=}0.01$ stable, $\lambda{=}0.05$ unstable), so
we describe the effect as a range, not a sharp threshold.
